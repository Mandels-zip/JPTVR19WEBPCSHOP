<%-- 
    ...
    Created on : Jun 11, 2021, 8:46:48 AM
    Author     : pupil
--%>
   ...
   <div class="w-50 d-flex justify-content-center mx-auto">
    <form class="row g-2" action="changeUser" method="POST">
       ...
       <div class="col-md-6">
        ...
        <div class="col-md-6">
          <label for="phone" class="form-label">Э-майл</label>
          <input type="text" class="form-control" id="email" name="email"  value="${user.customer.email}">
        </div>
        <div class="col-md-6">
